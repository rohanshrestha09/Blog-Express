...
module.exports.getAllBlogs = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        switch (sort) {
            ...
            default:
                return res.status(200).json({
                    blogs: yield Blog.find({}).limit(pageSize ? pageSize : 10),
                    message: "Blogs Fetched Successfully",
                });
        }
    }
    ...
    try {
        ...
        (0, storage_1.uploadBytes)(storageRef, file.data, metadata).then(() => {
            (0, storage_1.getDownloadURL)(storageRef).then((url) => __awaiter(void 0, void 0, void 0, function* () {
                return yield Blog.findByIdAndUpdate(new mongoose_1.default.Types.ObjectId(blog._id), { image: url, imageName: filename });
            }));
        });
        yield User.findByIdAndUpdate(new mongoose_1.default.Types.ObjectId(_authorId), {
            $push: {
                blogs: yield Blog.findById(new mongoose_1.default.Types.ObjectId(blog._id)),
            },
        });
...
module.exports.updateBlog = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!req.files)
            return res.status(403).json({ message: "Image required" });
        const blog = yield Blog.findById(new mongoose_1.default.Types.ObjectId(_blogId));
        yield User.findByIdAndUpdate(new mongoose_1.default.Types.ObjectId(blog.author), {
            $pull: {
                blogs: blog,
            },
        });
        ...
        (0, storage_1.uploadBytes)(storageRef, file.data, metadata).then(() => {
            (0, storage_1.getDownloadURL)(storageRef).then((url) => __awaiter(void 0, void 0, void 0, function* () {
                return yield Blog.findByIdAndUpdate(new mongoose_1.default.Types.ObjectId(blog._id), {
                    image: url,
                    imageName: filename,
                });
            }));
        ...
        yield User.findByIdAndUpdate(new mongoose_1.default.Types.ObjectId(blog.author), {
            $push: {
                blogs: yield Blog.findById(new mongoose_1.default.Types.ObjectId(_blogId)),
            },
        });
        return res.status(200).json({ message: "Blog Posted Successfully" });
    }
